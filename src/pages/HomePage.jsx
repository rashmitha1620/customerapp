      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-4 pb-8">
        ...
        <div className="relative bg-gradient-to-r from-emerald-400 to-emerald-500 rounded-2xl p-4 md:p-6 mb-6 overflow-hidden">
          <div className="relative z-10">
            <h2 className="text-white text-sm md:text-lg font-bold mb-2">SPECIAL OFFER</h2>
          ...
          <div className="absolute right-2 md:right-4 top-2 md:top-4 flex flex-col space-y-1 md:space-y-2">
            ...
            <img
              ...
              alt="Watch"
              className="w-10 h-10 md:w-12 md:h-12 object-cover rounded-lg shadow-lg"
            />
            <img
              src="https://images.pexels.com/photos/4465124/pexels-photo-4465124.jpeg?auto=compress&cs=tinysrgb&w=100"
              alt="Lotion"
              className="w-8 h-8 md:w-10 md:h-10 object-cover rounded-lg shadow-lg"
            />
          </div>
        </div>
